...
export function ScheduledPublishesSection({ currentUserRole }: ScheduledViewProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h2 id="scheduled-publishes-title" className="text-xl font-bold text-[#171717]">{t('scheduled.publishesTitle')}</h2>
